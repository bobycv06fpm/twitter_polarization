...
g = Graph.Read_Pickle("graph_pickles/phase1_replies_graph")
df = pd.read_pickle("topic_sentiment_pickles/phase1_tweets")
...
print(len(g.vs))
g.write_pickle("graph_pickles/phase1_tweets_graph")
