...
g = Graph.Read_Pickle("graph_pickles/phase2_replies_graph")
df = pd.read_pickle("topics_sentiment_pickles/phase2_tweets")
...
print(len(g.vs))
g.write_pickle("graph_pickles/phase2_tweets_graph")
