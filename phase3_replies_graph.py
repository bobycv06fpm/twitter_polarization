...
g = Graph.Read_Pickle("graph_pickles/phase3_repliedto_graph")
df = pd.read_pickle("topic_sentiment_pickles/phase3_replies")
...
print(len(g.vs))
g.write_pickle("graph_pickles/phase3_replies_graph")
