...
g = Graph.Read_Pickle("graph_pickles/phase2_repliedto_graph")
df = pd.read_pickle("topic_sentiment_pickles/phase2_replies")
...
print(len(g.vs))
g.write_pickle("graph_pickles/phase2_replies_graph")
