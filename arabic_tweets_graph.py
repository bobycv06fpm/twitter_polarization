...
g = Graph.Read_Pickle("graph_pickles/arabic_replies_graph")
df = pd.read_pickle("topic_sentiment_pickles/arabic_tweets")
...
print(len(g.vs))
g.write_pickle("graph_pickles/arabic_tweets_graph")
