...
g = Graph.Read_Pickle("graph_pickles/phase1_tweets_graph")
# g = Graph()
# g.add_vertex("1.0")
# g.add_vertex("2.0")
# g.vs[g.vs.find(name_eq = "2.0").index]["color"] = "purple"

neu0_df = pd.read_pickle("topic_sentiment_dfs/neu0_phase1")
neu1_df = pd.read_pickle("topic_sentiment_dfs/neu1_phase1")
neu2_df = pd.read_pickle("topic_sentiment_dfs/neu2_phase1")
neu3_df = pd.read_pickle("topic_sentiment_dfs/neu3_phase1")
neu4_df = pd.read_pickle("topic_sentiment_dfs/neu4_phase1")
neu5_df = pd.read_pickle("topic_sentiment_dfs/neu5_phase1")
neu6_df = pd.read_pickle("topic_sentiment_dfs/neu6_phase1")
neu7_df = pd.read_pickle("topic_sentiment_dfs/neu7_phase1")
neu8_df = pd.read_pickle("topic_sentiment_dfs/neu8_phase1")
neu9_df = pd.read_pickle("topic_sentiment_dfs/neu9_phase1")

pos0_df = pd.read_pickle("topic_sentiment_dfs/pos0_phase1")
pos1_df = pd.read_pickle("topic_sentiment_dfs/pos1_phase1")
pos2_df = pd.read_pickle("topic_sentiment_dfs/pos2_phase1")
pos3_df = pd.read_pickle("topic_sentiment_dfs/pos3_phase1")
pos4_df = pd.read_pickle("topic_sentiment_dfs/pos4_phase1")
pos5_df = pd.read_pickle("topic_sentiment_dfs/pos5_phase1")
pos6_df = pd.read_pickle("topic_sentiment_dfs/pos6_phase1")
pos7_df = pd.read_pickle("topic_sentiment_dfs/pos7_phase1")
pos8_df = pd.read_pickle("topic_sentiment_dfs/pos8_phase1")
pos9_df = pd.read_pickle("topic_sentiment_dfs/pos9_phase1")

neg0_df = pd.read_pickle("topic_sentiment_dfs/neg0_phase1")
neg1_df = pd.read_pickle("topic_sentiment_dfs/neg1_phase1")
neg2_df = pd.read_pickle("topic_sentiment_dfs/neg2_phase1")
neg3_df = pd.read_pickle("topic_sentiment_dfs/neg3_phase1")
neg4_df = pd.read_pickle("topic_sentiment_dfs/neg4_phase1")
neg5_df = pd.read_pickle("topic_sentiment_dfs/neg5_phase1")
neg6_df = pd.read_pickle("topic_sentiment_dfs/neg6_phase1")
neg7_df = pd.read_pickle("topic_sentiment_dfs/neg7_phase1")
neg8_df = pd.read_pickle("topic_sentiment_dfs/neg8_phase1")
neg9_df = pd.read_pickle("topic_sentiment_dfs/neg9_phase1")
...
g.save("full_graphs_POL/phase1_polarized_full.graphml")
